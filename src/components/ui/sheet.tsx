  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          'bg-base-black data-[state=open]:animate-in data-[state=closed]:animate-out fixed z-50 flex flex-col gap-4 shadow-lg transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500',
          side === 'right' &&
      ...
      >
        ...
        {children}
        <SheetPrimitive.Close className='ring-offset-background data-[state=open]:bg-secondary absolute top-7 right-4 cursor-pointer rounded-xs opacity-70 transition-opacity outline-none hover:opacity-100 disabled:pointer-events-none'>
          <X className='size-6' />
